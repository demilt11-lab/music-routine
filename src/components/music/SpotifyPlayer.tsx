...
import {
  Music, Search, Play, Pause, LogIn, LogOut, Loader2, ExternalLink,
} from "lucide-react";
      ...
      <Card className="border-dashed">
        <CardContent className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-sm text-muted-foreground mb-6 max-w-sm">
            Link your Spotify account to search and preview millions of tracks during your sessions.
          </p>
            ...
            {tracks.map((track) => {
              ...
              return (
                <div
                  ...
                  onClick={() => (isActive && isPlaying ? onPause() : onPlay(track))}
                >
